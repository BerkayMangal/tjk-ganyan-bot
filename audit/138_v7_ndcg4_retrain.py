#!/usr/bin/env python3
"""V7 LambdaRank ndcg@4 retrain — top4 odaklı loss.
...
Output: model/trained_v7_ndcg4/ + audit/reports/phase_5_8_45_ndcg4_paired.md
"""
...
OUT_DIR = os.path.join(REPO, 'model', 'trained_v7_ndcg4')
REP = os.path.join(REPO, 'audit', 'reports', 'phase_5_8_45_ndcg4_paired.md')
...
def main():
    ...
    with open(REP, 'w') as f:
        ...
        for breed in ('arab', 'english'):
            ...
            f.write(f"| Metric | V7 (pairwise) | V7-ndcg@4 | Δ |\n|---|---|---|---|\n")
            for k in (1, 2, 3, 4, 5):
